...
def macro_f_score(conf_matrix: np.array, f_score_false_negatives = f1_score):
    ...
    for i, per_label_confmat in enumerate(conf_matrix):
        ...
        per_label_f1_scores[i] = f_score_false_negatives(true_positives=true_positives, false_positives=false_positives, false_negatives=false_negatives)

    return np.mean(per_label_f1_scores)


def weighted_f_score(conf_matrix, f_score_false_negatives = f1_score):
    ...
    for i, per_label_confmat in enumerate(conf_matrix):
        ...
        per_label_f_scores[i] = f_score_false_negatives(true_positives=true_positives, false_positives=false_positives, false_negatives=false_negatives)
...
def micro_f_score(conf_matrix: np.array, f_score_false_negatives = f1_score):
    true_positives = np.sum(conf_matrix[:, 1, 1])
    false_positives = np.sum(conf_matrix[:, 0, 1])
    false_negatives = np.sum(conf_matrix[:, 1, 0])

    return f_score_false_negatives(true_positives=true_positives, false_positives=false_positives, false_negatives=false_negatives)
...
def multilabel_classification_report(conf_matrix, label_names):
    ...
    return {
        ...
        "macro_f2": macro_f_score(conf_matrix, f_score_false_negatives=f2_score),
        "macro_f0_5": macro_f_score(conf_matrix, f_score_false_negatives=f0_5_score),
        "micro_f1": micro_f_score(conf_matrix),
        "micro_f2": micro_f_score(conf_matrix, f_score_false_negatives=f2_score),
        "micro_f0_5": micro_f_score(conf_matrix, f_score_false_negatives=f0_5_score),
        "weighted_f1": weighted_f_score(conf_matrix),
        "weighted_f2": weighted_f_score(conf_matrix, f_score_false_negatives=f2_score),
        "weighted_f0_5": weighted_f_score(conf_matrix, f_score_false_negatives=f0_5_score),
    }
